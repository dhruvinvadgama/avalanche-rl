...
import json
from avalanche_rl.models.dqn import MLPDeepQN, ConvDeepQN
...
model = ConvDeepQN(4, (84, 84), action_space)
...
strategy = DQNStrategy(
    ...
    per_experience_steps=[Timestep(int(1e5)),
                          Timestep(int(1e5))], batch_size=32, exploration_fraction=.15,
...
for experience in scenario.train_stream:
    ...
    #model._compute_flattened_shape(500)
    ...
    torch.save(
            ...
            'synaptic_intelligence_pong-breakout.pt')
